...
# Statistical Data
RATIO_CANOLA = 0.00021645021645021645 # Magnification 692x  2560*1920 
SCALEBAR_UNIT = 0.05 #mm 


# Plots
STOMATA_DESITY= 'Stomata Desity'
STOMATA_SIZE = 'Stomata Size(mm²)'
PORE_SIZE ='Pore Size(mm²)'
#------------------------------------------------------------------------------------------------
